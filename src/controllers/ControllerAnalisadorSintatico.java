...
public class ControllerAnalisadorSintatico {
    ...
    private void procedureFunctionDeflf() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureFunctionDeflf()");
            this.errosSintaticos += "Erro 9* - Delimitador ')' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureConstDef() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("const")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("{")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro - Delimitador '{' não encontrado na linha "+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
                    }
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureConstDef()");
                    this.errosSintaticos += "Erro - Delimitador '{' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureConstDef()");
            this.errosSintaticos += "Erro 29 - Palavra Reservada 'const' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
            ...
            if(atual[1].trim().equals("struct")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[0].contains("Identificador_")) {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 30 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                    ...
                    this.errosSintaticos += "Erro 30 - Identificador não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 31 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStructDef()");
            this.errosSintaticos += "Erro 31 - Palavra Reservada 'struct' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
            ...
            if(atual[1].trim().equals("{")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("}")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro 32 - "+atual2[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
                    }
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStructDeflf()");
                    this.errosSintaticos += "Erro 32 - Delimitador '}' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }
            ...
            // Verifica se o token atual eh 'extends'    
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[0].contains("Identificador_")) {
                            ...
                            if(atual3[1].trim().equals("{")) {
                                ...
                                if(this.idTokenAtual < this.tokens.getSize()) {
                                    ...
                                    if(atual4[1].trim().equals("}")) {
                                        ...
                                        this.errosSintaticos += "Erro 33 - "+atual4[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
                                    }
                                } else {
                                ...
                                // Erro
                                String linha = atual3[2].replaceAll(">", " ");
                                this.errosSintaticos += "Erro 34 - "+atual3[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
                            }
                        } else {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 35 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
                    }
                } else {
                    
                    System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStructDeflf()");
                    this.errosSintaticos += "Erro 35 - Identificador não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {

                // Erro
                this.errosSintaticos += "Erro 36 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start, Identificador_");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStructDeflf()");
            this.errosSintaticos += "Erro 36* - Delimitador '{' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureDeclaration() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals(";")) {
                ...
                // Erro
                this.errosSintaticos += "Erro 37 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
    ...
    private void procedureInitializer() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            // Verifica se o token atual eh '{'
                ...
                // Erro
                this.errosSintaticos += "Erro 38 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
            ...
            // Verifica se o token atual eh ','         
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("}")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro 39 - "+atual2[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                        this.modalidadeDesespero2("}, ;");                        
                    }
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureInitializerlf()");
                    this.errosSintaticos += "Erro 39 - Delimitador '}' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {

                // Erro
                this.errosSintaticos += "Erro 40 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                this.modalidadeDesespero2("}, ;");
            }
        } else {
    ...
    private void procedureDeclarator() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[0].contains("Identificador_")) {
                ...
                // Erro    
                this.errosSintaticos += "Erro 41 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                this.modalidadeDesespero2("=, ;, ), (");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureDeclarator()");
            this.errosSintaticos += "Erro 41 - Identificador não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    } 
    ...
    private void procedureDeclarator1lf() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("false") || atual[1].trim().equals("true") ||
                    ...
                    if(this.idTokenAtual < this.tokens.getSize()) {
                        ...
                        if(atual2[1].trim().equals("]")) {
                            ...
                            // Erro
                            String linha = atual2[2].replaceAll(">", " ");
                            this.errosSintaticos += "Erro 42 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                            this.modalidadeDesespero2("=, ;, ), (");
                        }
                    } else {
                        
                        //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureDeclarator1lf()");
                        this.errosSintaticos += "Erro 42 - Delimitador ']' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                    }                
            ...
            // Verifica se o token atual eh ']'
                ...
                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 43 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero2("=, ;, ), (");
            }
        } else {
    ...
    private void procedureStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            this.errosSintaticos += "Erro 44 - Declaração esperada não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureStartDef() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("start")) {
                    ...
                    if(atual2[1].trim().equals("(")) {
                        ...
                        if(this.idTokenAtual < this.tokens.getSize()) {
                            ...
                            if(atual3[1].trim().equals(")")) {                    
                                    ...
                                    if(atual4[1].trim().equals("{")) {
                                        ...
                                        if(this.idTokenAtual < this.tokens.getSize()) {
                                            ...
                                            if(atual5[1].trim().equals("}")) {
                                                ...
                                                // Erro                            
                                                this.errosSintaticos += "Erro 46 - "+atual5[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                                                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
                                            }
                                        } else {
                                                
                                            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStartDef()");
                                            this.errosSintaticos += "Erro 46 - Delimitador '}' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                                        }                        
                                    } else {

                                        // Erro
                                        this.errosSintaticos += "Erro 47 - "+atual4[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
                                    }
                                } else {
                                ...
                                // Erro
                                String linha = atual3[2].replaceAll(">", " ");
                                this.errosSintaticos += "Erro 48 - "+atual3[1].trim()+ "inesperado na linha"+linha.trim()+".\n";   
                                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
                            }
                        } else {
                        ...
                        // Erro  
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 49 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
                    }
                } else {
                ...
                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 50 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("struct, procedure, typedef, const, function, var, start");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureStartDef()");
            this.errosSintaticos += "Erro 50 - Palavra Reservada 'Start' esperada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }                
    }
    ...
    private void procedurePrintStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("print")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("(")) {
                            ...
                            if(atual3[1].trim().equals(")")) {
                                ...
                                if(this.idTokenAtual < this.tokens.getSize()) {
                                    ...
                                    if(atual4[1].trim().equals(";")) {
                                        ...
                                        // Erro
                                        this.errosSintaticos += "Erro 51 - "+atual4[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
                                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                                    }
                                } else {
                                    ...
                                    this.errosSintaticos += "Erro 51 - Delimitador ';' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                                }                    
                            } else {

                                // Erro
                                String linha = atual3[2].replaceAll(">", " ");
                                this.errosSintaticos += "Erro 52 - "+atual3[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                            }
                        } else {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 53 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                ...
                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 54 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePrintStmt()");
            this.errosSintaticos += "Erro 54 - Palavra Reservada 'print' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    } 
    ...
    private void procedureScanStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("scan")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("(")) {
                            ...
                            if(atual3[1].trim().equals(")")) {
                                ...
                                if(this.idTokenAtual < this.tokens.getSize()) {
                                    ...
                                    if(atual4[1].trim().equals(";")) {
                                        ...
                                        // Erro
                                        this.errosSintaticos += "Erro 55 - "+atual4[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
                                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                                    }
                                } else {
                                    ...
                                    this.errosSintaticos += "Erro 55 - Delimitador ';' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                                }                    
                            } else {

                                // Erro
                                String linha = atual3[2].replaceAll(">", " ");
                                this.errosSintaticos += "Erro 56 - "+atual3[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                            }
                        } else {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 57 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                ...
                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 58 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureScanStmt()");
            this.errosSintaticos += "Erro 58 - Palavra Reservada 'scan' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureIterationStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("while")) {
                    ...
                    if(atual2[1].trim().equals("(")) {
                        ...
                        if(this.idTokenAtual < this.tokens.getSize()) {
                            ...
                            if(atual3[1].trim().equals(")")) {
                                ...
                                // Erro
                                String linha = atual3[2].replaceAll(">", " ");
                                this.errosSintaticos += "Erro 59 - "+atual3[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                            ...
                            this.errosSintaticos += "Erro 59 - Delimitador ')' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                        }                
                    } else {

                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 60 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if,"
                                        + " while, ;, {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                ...
                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 61 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if,"
                                        + " while, ;, {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureIterationStmt()");
            this.errosSintaticos += "Erro 61 - Palavra Reservada 'while' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureIfStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("if")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("then")) {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 62 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;, {,"
                                + " scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                    ...
                    this.errosSintaticos += "Erro 62 - Palavra Reservada 'then' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 63 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;, {,"
                                + " scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureIfStmt()");
            this.errosSintaticos += "Erro 63 - Palavra Reservada 'if' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }    
    ...
    private void procedureReturnStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("return")) {
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals(";")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro 64 - "+atual2[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                    ...
                    this.errosSintaticos += "Erro 64 - Delimitador ';' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 65 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificacor_");
            }
        } else {
            ...
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedureReturnStmt()");
            this.errosSintaticos += "Erro 65 - Palavra Reservada 'return' não encontrada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureCompoundStmt() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            if(atual[1].trim().equals("{")) {
                ...
                // Erro
                this.errosSintaticos += "Erro 66 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                        + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            this.errosSintaticos += "Erro 66 - Delimitador '{' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }                
    } 
            ...
            // Verifica se o token atual eh primeiro de <StmtOrDeclarationList>  
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("}")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro 67 - "+atual2[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                ...
                // Erro
                this.errosSintaticos += "Erro 68 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(this.idTokenAtual-1)+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
            ...
            // Verifica se o token atual eh primeiro de <Expr>    
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals(";")) {
                        ...
                        // Erro
                        this.errosSintaticos += "Erro 69 - "+atual2[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
                        this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
                    }
                } else {
                    ...
                    this.errosSintaticos += "Erro 69 - Delimitador ';' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }            
            } else {

                // Erro
                this.errosSintaticos += "Erro 70 - "+atual[1].trim()+ "inesperado na linha"+this.getLinhaErro(idTokenAtual-1)+".\n";
                this.modalidadeDesespero("false, (, return, print, else, !, ++, --, Numero, }, if, while, ;,"
                                + " {, scan, true, Cadeia_de_Caracteres, var, Identificador_");
            }
        } else {
    ...
    private void procedureUnaryExpr() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            this.errosSintaticos += "Erro 71 - Expressão inválida na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }   
            ...
            // Verifica se o token atual eh '('    
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals(")")) {
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 72 - "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero2("*, (, <=, ++, --, ==, =, }, !=, ;, /, -,'+, then, ), ||, &&, >, ], <, [, >=, .");
                    }  
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePrimaryExpr()");
                    this.errosSintaticos += "Erro 72 - Delimitador ')' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }                      
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 73 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero2("*, (, <=, ++, --, ==, =, }, !=, ;, /, -,'+, then, ), ||, &&, >, ], <, [, >=, .");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePrimaryExpr()");
            this.errosSintaticos += "Erro 73 - Expressão mal formada na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
    ...
    private void procedureEqualOp() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            this.errosSintaticos += "Erro 74 - Operador ('==' ou '!=') não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            // Verifica se o token atual é '['    
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals("]")){
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 79 -"+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero2("*, (, <=, ++, --, ==, =, }, !=, ;, /, -, +, then, ), ||, &&, >, ], <, [, >=, .");
                    }
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePostfixOp()");
                    this.errosSintaticos += "Erro 79 - Delimitador ']' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }
            ...
            // Verifica se o token atual é '.'      
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePostfixOp()");
                    this.errosSintaticos += "Erro 80 - Identificador não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 81 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";  
                this.modalidadeDesespero2("*, (, <=, ++, --, ==, =, }, !=, ;, /, -, +, then, ), ||, &&, >, ], <, [, >=, .");
            }
        } else {
            
            //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePostfixOp()");
            this.errosSintaticos += "Erro 81 - Operador ou Delimitador não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";  
        }   
    } 
            ...
            // Verifica se o token atual eh primeiro de <ArgumentList>
                ...
                if(this.idTokenAtual < this.tokens.getSize()) {
                    ...
                    if(atual2[1].trim().equals(")")){
                        ...
                        // Erro
                        String linha = atual2[2].replaceAll(">", " ");
                        this.errosSintaticos += "Erro 82 "+atual2[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                        this.modalidadeDesespero2("-, +, then, *, ), (, <=, ||, ++, --, ==, &&, >, =, ], }, <, !=, [, >=, ;, /, .");
                    } 
                } else {
                    
                    //System.err.println("Erro - idTokenAtual > tokens.getSize() em procedurePostfixOplf()");
                    this.errosSintaticos += "Erro 82 - Delimitador ')' não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
                }    
            } else {

                // Erro
                String linha = atual[2].replaceAll(">", " ");
                this.errosSintaticos += "Erro 83 - "+atual[1].trim()+ "inesperado na linha"+linha.trim()+".\n";
                this.modalidadeDesespero2("-, +, then, *, ), (, <=, ||, ++, --, ==, &&, >, =, ], }, <, !=, [, >=, ;, /, .");
            } 
        } else {
    ...
    private void procedureType() {
        ...
        if(this.idTokenAtual < this.tokens.getSize()) {
            ...
            this.errosSintaticos += "Erro 84 - Tipo não encontrado na linha "+this.getLinhaErro(this.tokens.getSize()-1)+".\n";
        }        
    }
